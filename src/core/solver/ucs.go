...
func (u *UCSSolver) Name() string { return "UCS" }
...
func (u *UCSSolver) Solve(m *models.MapData) (*models.SolverResult, error) {
	...
	return &models.SolverResult{Success: false, SearchFrames: searchFrames, TimeMs: time.Since(startTime).Milliseconds(), NodesEval: nodesEvaluated, Algorithm: "UCS"}, nil
}
